...
class Tech(models.Model):
	...
	def icon(self, value):
		if(self._icon != value):
			...
			self._debug_val = "self._icon : "+ self._icon +" AND value : "+ value
		#self.icon_g = SimpleUploadedFile(path_g, image_grey)
		self._icon = value
	'''
	#overide save
	def save(self, *args, **kwargs):
		...
		if getattr(self, '_image_changed', True):
			self.icon_g = getattr(self, '_debug_val')
